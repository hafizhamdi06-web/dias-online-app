...
<div class="container-fluid px-0">
      <table id="transaksi-table" class="table table-sm table-striped table-hover table-responsive w-100 bg-light d-none">
        <thead>
        <tr>
        <th class="d-none"></th>            
        <th></th>
...
<script src="<? echo app_url('assets/dist/js/modul/include/modal-uangmuka.js'); ?>"></script> 