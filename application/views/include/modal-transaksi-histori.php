...
<div class="modal-footer">
    <div class="form-group">
        <div class="col-sm-offset-3">
            <a class="btn btn-primary btn-sm px-4" data-dismiss="modal" aria-hidden="true" data-toggle='modal' href="#">OK</a> 
        </div>
    </div>                
</div>

<script src="<? echo app_url('assets/dist/js/modul/include/modal-transaksi-histori.js'); ?>"></script> 