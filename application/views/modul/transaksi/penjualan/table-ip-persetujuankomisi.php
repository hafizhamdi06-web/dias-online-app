<body id="<?= $id; ?>" class="layout-fixed overflow-hidden" data-panel-auto-height-mode="height">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top:70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        ...
        <div id="fDataTable" class="fDataTable d-none">
          ...
          <div class="row ml-3 mt-4 pt-0">
            <button type="button" id="editdepo" class="btn btn-primary btn-sm">APPROVE</button>
          </div>
  ...
  <div class="btn-group-vertical">
      <a id="badd" class="btn btn-app disabled" >
        <i class="fas fa-plus"></i> <span>Tambah</span>
      </a>
      <a id="bedit" class="btn btn-app disabled" >
        <i class="fas fa-edit"></i> <span>Edit</span>
      </a>
      <a id="bdelete" class="btn btn-app disabled" >
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/table-ip-persetujuankomisi_2.js'); ?>"></script>
</body>
</html>
