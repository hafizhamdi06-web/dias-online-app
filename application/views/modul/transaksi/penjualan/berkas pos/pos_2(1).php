<body id="<?= $id; ?>" class="layout-fixed bg-transparent overflow-hidden" data-panel-auto-height-mode="height"> 
  ...
  <div class="content-wrapper tab-wrap mx-0"  style="width:100%; height:50%">
        ...
        <div class="content-header bg-white px-0 py-0 position-fixed w-100">  
                        <div class="card card-body">  
                                            ...
                                            <div class="form-group row my-0">
                                             ...
                                             <div class="form-group row my-0">  
                                                <div class="col-8  col-sm-5  col-lg-4" id="divtglexpiredmember"> </div>  
                                                <div class="col-1 col-sm-1 col-lg-2 " id="bstatuskartumember"></div>
                                             </div>   
                        </div>
    ...
    <section class="content2" style="margin-top:150px;">  
        <div class="py-99">
      <div class="container-fluid mt-1 px-0 mx-0 ">         
                            <div class="card-body">     
                                    <div class="table border-1" tabindex="-1">
                                        <table id="tdetil" class="table  table-sm "> 
                                            <tbody>  
                                            </tbody>
                ...
                <div class="form-group row my-0">
                    <div class="col-8  px-3 "> 
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <button type="button" id="btambahitem" class="btn btn-success btn-step1 text-sm btn-sm buttontambahan" role="button"><i class="fa fa-plus px-2"></i>Tambah Item</button>
                                                     ...
                                                     <div class="form-group row my-0"> 
                                                        <div class="col-12">  
                                                             <div class="form-label-group">
                                            	                  <input type="text" name="username" id="username" class="form-control text-sm" placeholder="Nama User" required autofocus> 
                                            	                </div>
                                            	                <div class="form-label-group">
                ...
                <div class="modal fade" id="modaloperator" role="dialog"  data-backdrop="static">
                    <div class="modal-dialog  modal-lg">
                        <div class="modal-content">
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h6 class="modal-title" id="labelmodaloperator">Pilih Operator</h6>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form role="form">
                					...
                					<input id="noicnya" type="text" class="form-control form-control-sm " value="0" autofocus tabindex="1">
                            ...
                            <!-- Modal Footer -->
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary btn-block" data-dismiss="modal" id="boknoic" tabindex="-1">OK</button>  
                            </div>
                        </div>
                    </div>
                </div>
