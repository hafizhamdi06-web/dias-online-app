<body id="<?= $id; ?>" class="layout-fixed bg-transparent overflow-hidden" data-panel-auto-height-mode="height">
  ...
  <div class="content-wrapper tab-wrap mx-0"  style="width:100%">
    <div class="content-header bg-white px-2 py-2 position-fixed w-100">
      <div class="row">
      <span class="text-md text-olive  pl-3">Penjualan</span>                
      <ul class="navbar-nav">
             ...
             <div class="form-group row my-0">        
                <div class="col-12">  
                    <div class="btn-group" role="group" aria-label="Basic example"> 
                        ...
                        <button type="button" id="bweb" class="btn btn-danger btn-step1 text-sm btn-lg" role="button"><i class="fa fa-plus px-2"></i>Web</button> 
                               ...
                               <div class="card collapsed-card  card-success  ">
                                ...
                                <div class="card-body mx-0 px-0">  
                                    ...
                                    <div class="card collapsed-card  card-light  ">
                                        ...
                                        <div class="card-body mx-0 px-0">    
                                             <div class="form-group row my-0">
                                                <label class="col-4 col-form-label text-sm px-3 font-weight-normal">Kas</label>
                                                <div class="col-8">   
                                                         <div class="input-group" data-target-input="nearest">
