  ...
  <div class="content-wrapper tab-wrap mx-0"  style="width:100%; height:50%">
    ...
    <section class="content"  >  
      <div class="container-fluid">       
        <div class="card card-body card-outline-tabs-body">  
        <div class="row g-4"> <!--begin::Col--> 
             <div class="col-md-4"> <!--begin::Quick Example-->
              <div class="card card-outline card-primary  "> <!--begin::Header-->
              <div class="card-body">
                <h5 class="card-title"><input type="text" id="nomor" name="nomor" class="form-control form-control-sm kuncitext border-0 "  ></h5>
                <input type="text" id="tgl" name="tgl" class="form-control form-control-sm datepicker kuncitext  border-0 " autocomplete="off">
             ...
             <div class="col-md-4"> <!--begin::Quick Example-->
              ...
              <div class="card-body"> 
                                                      <div class="input-group" data-target-input="nearest">
                                                        ...
                                                        <input type="text" id="namakontak" name="namakontak" class="form-control form-control-sm kuncitext" placeholder="Cari Pasien">
                                                        <div id="carikontak" class="input-group-append btn  btn-primary btn-sm " role="button">
                                                           <i class="fa fa-search"></i>
                                                        </div>  
                                                        <div id="bpasien" class="input-group-append btn  btn-primary btn-sm" role="button">
                                                            <i class="fa fa-edit"></i>
                                                        </div> 
                                                      </div> 
                                                      
                                                      
                                                            <div id="divtglexpiredmember"> </div>  
              ...
              <div class="card-body"> 
                                                      <div class="col-lg-6 col-6"> <!-- small box -->
                                                        <div class="small-box">
                                                            <div class="inner">
                                                                <p>Total Transaksi</p>
                                                                <div id="ptotaltransaksi" class"numeric align-right"><h3>0</h3></div>
                                                            </div>  
                                                        </div>
                                                    </div> <!-- ./col -->   
    ...
    <input type="hidden" class="noclear" id="cabanguser" name="cabanguser" value="<? echo @$_SESSION['cabang']; ?>">   
                                                            <input id="tsubtotal" type="hidden" class="total form-control form-control-sm numeric border-1 kuncitext  "   value="0"> 
                                                            <input id="totalbayar" type="hidden" class="total form-control form-control-sm numeric border-1 kuncitext " value="0">
                                                            <input id="totalsisa" type="hidden" class="total form-control form-control-sm numeric border-1 kuncitext" value="0" >      
    ...
    <input type="hidden" class="noclear" id="bisapprove" name="bisapprove" value="<?= $bisapprove ?>">  
                                         ...
                                         <thead class="bg-light">
                                            <tr>
                                              ...
                                              <div class="form-group row my-0">
                                                    ...
                                                    <label class="col-1 col-form-label text-sm px-3 font-weight-normal"  >Qty </label> 
                                                    <label class="col-1 col-form-label text-sm px-3 font-weight-normal"  >Harga </label> 
                                                    <label class="col-1 col-form-label text-sm px-3 font-weight-normal"  >Dis 1 </label> 
                                                    <label class="col-1 col-form-label text-sm px-3 font-weight-normal"  >Dis 2 </label> 
                                                    <label class="col-1 col-form-label text-sm px-3 font-weight-normal"  >Sub Total </label> 
                                                    <label class="col-2 col-form-label text-sm px-3 font-weight-normal"  >Aksi </label> 
                                             </div> 
                                              </th> 
                                            </tr>
                                          </thead>
...
<!-- Modal modaldiskonvocer -->
                <div class="modal fade" id="modaldiskonvocer" role="dialog"  data-backdrop="static">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <!-- Modal Header -->
                            <div class="modal-header">
                                        ...
                                        <div class="form-group row my-0">
                                            <div class="col-12">    
                                                ...
                                                <div class="card-body mx-0 px-0">   
                                                     <div class="form-group row my-0"> 
                                                        <div class="col-12">  
                                                            <input id="nodiskonvocer" type="text" class="nodiskonvocer form-control form-control-sm border-1 " value=""> 
                                                        </div>        
                                                      </div>   
                                                 </div>                
                                                </div> 
                            ...
                            <!-- Modal Footer -->
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary btn-sm" id="bokmodaldiskonvocer">OK</button>  
                                <button type="button" class="btn btn-primary btn-sm" data-dismiss="modal" >Cancel</button>  
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-body">
                                <form role="form"> 
                					<select id="pilihanpaket" name="pilihanpaket" class="form-control select2 form-control-sm"  data-trigger="manual" data-placement="auto"></select> 
                						...
                						<input id="statuspaket" type="text" class="form-control form-control-sm " value="0">
                                </form>
                            </div>
