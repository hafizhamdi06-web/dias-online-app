  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <section class="content" style="margin-top:70px">
      <div class="container-fluid pt-4">
          ...
          <div class="form-group row my-0">
            <label class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Alamat</label>
            <div class="col-sm-3">
      ...
      <div class="container-fluid container-absolute">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 d-none">
                <label class="text-sm px-2 font-weight-normal">No.PO Pelanggan</label>              
                  <div class="input-group" data-target-input="nearest">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="hidden" id="defpajak" value="<?= $pajakjual; ?>" class="nilaipajak">                
                  <select id="pajak" name="pajak" class="form-control select2 text-sm" style="width:100%">
    ...
    <section class="content mt-4">
      <div class="container-fluid">
          <div class="row pt-0">
            ...
            <div class="col-sm-10">
                <textarea class="form-control form-control-sm" rows="1" id="uraian" name="uraian"></textarea>
            </div>
          </div>
          ...
          <div class="row px-1 mt-4">
            <label class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Alamat Kirim</label>
            <div class="col-sm-3">
                <textarea id="alamatkirim" name="alamatkirim" class="form-control form-control-sm" rows="2" autocomplete="off" style="height:4em"></textarea>
            </div>
          </div>
          <div class="row px-1 my-1">
            <label class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Catatan</label>
            <div class="col-sm-3">
                <textarea id="catatan" name="catatan" class="form-control form-control-sm"  rows="1" autocomplete="off"></textarea>
            </div>
          ...
          <div class="row px-1 mt-4 pt-2">
            ...
            <div id="col-pph22" class="col-sm-2 col-overlap-2 d-none">
              <div class="form-group">
                ...
                <label for="chkpph22" class="text-sm px-1 font-weight-normal ml-4">PPH 22 
                  <span id="persen-pph22"><? if($pph22jual>0) echo '('.$pph22jual.'%)'; ?></span>
                </label>                                
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/order-penjualan.js'); ?>"></script>
</body>
</html>