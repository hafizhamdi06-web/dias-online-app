    ...
    <section class="content" style="margin-top: 70px">
          ...
          <div class="form-group row my-0">
            ...
            <div class="col-sm-2">
                  <div class="input-group" data-target-input="nearest">
                    ...
                    <div id="carikontak" class="input-group-append" role="button" data-dismiss="modal">
      ...
      <div class="container-fluid container-absolute">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
                <label class="text-sm px-1 font-weight-normal">No. Order</label>              
                  <div class="input-group" data-target-input="nearest">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/surat-jalan.js'); ?>"></script>
</body>
</html>