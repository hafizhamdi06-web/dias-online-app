    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-8 col-12 mb-2">
                <label class="text-sm font-weight-normal mb-1">File Template Transaksi Shopee (.xlsx, sheet "Sheet1")</label>
            ...
            <small class="text-muted">
              Data disimpan ke tabel staging <code>zztemptransshopee</code>. Baris dengan No. Pesanan yang sama
              akan ditimpa saat diimport ulang, bukan diduplikasi. Pemrosesan ke transaksi (fstoku) menyusul.
            </small>
          </div>
        </div>
        ...
        <table id="riwayat-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          ...
          <th class="text-sm">Waktu Pesanan Dibuat</th>
          <th class="text-sm">Status Pesanan</th>
          <th class="text-sm">Nama Produk</th>
          <th class="text-sm text-right">Jumlah</th>
          <th class="text-sm text-right">Total Pembayaran</th>
...
<!-- JS Custom -->
<script src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/import-trans-shopee.js'); ?>"></script>
</body>
</html>
