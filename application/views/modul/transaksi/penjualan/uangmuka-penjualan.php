  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <section class="content">
      <div id="dLeftFirst" class="container-fluid left px-2">
        ...
        <div class="row px-2">
          <label for="" class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">COA Uang Muka [K] *</label>
          <div class="col-sm-3">
        ...
        <div id="hutang" class="row px-2 d-none">
          <label for="" class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">COA Piutang [D] *</label>
          <div class="col-sm-3">
        ...
        <div class="row px-2">
          ...
          <div class="col-sm-1">
            ...
            <input id="uang" type="text" class="form-control form-control-sm" readonly="" tabindex="-1" value="Rp">
          </div>
        </div>  
        <div class="row px-2">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/uangmuka-penjualan.js'); ?>"></script>
</body>
</html>