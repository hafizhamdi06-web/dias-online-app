                        ...
                        <table id="tdetil" class="table table-hover table-sm table-transaksi">
                          <thead class="bg-light">
                            <tr>
                              ...
                              <th class="text-sm text-label text-center border-0" style="width: 140px">No. Order</th>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/faktur-penjualan-dua.js'); ?>"></script>
</body>
</html>