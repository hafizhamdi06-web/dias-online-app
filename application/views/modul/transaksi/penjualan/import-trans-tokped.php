    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-8 col-12 mb-2">
                <label class="text-sm font-weight-normal mb-1">File Export Pesanan Tokopedia (.xlsx, sheet "OrderSKUList")</label>
            ...
            <small class="text-muted">
              Data disimpan ke tabel staging <code>zztemptranstokped</code>. Baris dengan Order ID yang sama
        ...
        <table id="riwayat-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          ...
          <th class="text-sm">Buyer Username</th>
          <th class="text-sm">Created Time</th>
          <th class="text-sm">Order Status</th>
          <th class="text-sm">Product Name</th>
          <th class="text-sm text-right">Quantity</th>
          <th class="text-sm text-right">Order Amount</th>
...
<!-- JS Custom -->
<script src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/import-trans-tokped.js'); ?>"></script>
</body>
</html>
