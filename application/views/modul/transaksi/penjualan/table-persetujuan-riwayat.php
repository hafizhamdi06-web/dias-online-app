    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        <table id="riwayat-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          ...
          <th class="text-sm">Approver</th>
          <th class="text-sm">Status</th>
          <th class="text-sm">Tgl Minta</th>
          <th class="text-sm">Tgl Respon</th>
        ...
        <div id="fDataTable" class="fDataTable d-none">
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                ...
                <input type="text" id="jenis" class="form-control form-control-sm" autocomplete="off">
              </div>
          </div>
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                <label class="col-form-label text-sm font-weight-normal">Referensi :</label>
                <input type="text" id="referensi" class="form-control form-control-sm" autocomplete="off">
              </div>
          </div>
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                <label class="col-form-label text-sm font-weight-normal">Keterangan :</label>
                <input type="text" id="keterangan" class="form-control form-control-sm" autocomplete="off">
              </div>
          </div>
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
          ...
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                <label class="col-form-label text-sm font-weight-normal">Dari Tgl Minta :</label>
          ...
          <div class="row mt-0 pt-0 mx-1">
              <div class="col-sm-12">
                <label class="col-form-label text-sm font-weight-normal">Sampai Tgl Minta :</label>
                <div class="input-group date">
...
<!-- JS Custom -->
<script src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/table-persetujuan-riwayat.js'); ?>"></script>
</body>
</html>
