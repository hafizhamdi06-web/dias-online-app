            ...
            <div class="row">
              <div class="col-md-8 col-12 mb-2">
                <small class="text-muted">
                  Menarik daftar produk toko Shopee lewat API (product/get_item_list + get_item_base_info),
                  lalu mencocokkan SKU-nya dengan kode item lokal (Update SKU Marketplace / kode item).
                  Toko harus sudah terhubung lewat menu <b>Seting API Marketplace Shopee</b>.
                </small>
              </div>
              <div class="col-md-4 col-12 mb-2">
                <button type="button" id="btarik" class="btn btn-primary btn-sm btn-block"><i class="fas fa-sync"></i> Tarik Produk dari Shopee</button>
              </div>
            </div>
          </div>
        </div>

        <table id="produk-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>
          <th></th>
          <th class="text-sm">Item ID</th>
          <th class="text-sm">SKU Shopee</th>
          <th class="text-sm">Nama Produk</th>
          <th class="text-sm text-right">Harga</th>
          <th class="text-sm text-right">Stok</th>
          <th class="text-sm">Status</th>
          <th class="text-sm">Kode Lokal Cocok</th>
          <th class="text-sm">Update Time (Shopee)</th>
...
<!-- JS Custom -->
<script src="<? echo app_url('assets/dist/js/modul/transaksi/penjualan/shopee-api-produk.js'); ?>"></script>
</body>
</html>
