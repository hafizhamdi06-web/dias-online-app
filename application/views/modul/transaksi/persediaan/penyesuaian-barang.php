  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="container-fluid pt-4">
        <div class="form-group row my-0">
          <label class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Kontak *</label>
          <div class="col-sm-2">
        ...
        <div class="form-group row my-0">
          <label class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Jenis Penyesuaian *</label>
          <div class="col-sm-2">
            <select id="jenis" name="jenis" class="form-control form-control-sm select2" style="width:100%" data-trigger="manual" data-placement="auto">
            </select>
          </div>
        </div>          
      </div>
      <div class="container-fluid container-absolute-120">
          <!-- Isi -->
          <div class="row mt-0">
            <div class="col-sm-3">
            </div>           
      ...
      <div class="container-fluid">
        <div class="form-group row mt-4">
                      ...
                      <table id="tdetil" class="table table-hover table-sm table-transaksi">
                        <thead class="bg-light">
                          <tr>
                            ...
                            <th class="text-sm text-label text-center border-0" style="width: 80px">Masuk</th>
                            <th class="text-sm text-label text-center border-0" style="width: 80px">Keluar</th>
          ...
          <div class="row px-1">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">Total Masuk</label>
                <input id="tqtyin" type="text" class="total form-control form-control-sm border-0" value="0" disabled>
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">Total Keluar</label>
                <input id="tqtyout" type="text" class="total form-control form-control-sm border-0" value="0" disabled>
              </div>
            </div>            
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">Total Transaksi</label>
                <input id="tsubtotal" type="text" class="total form-control form-control-sm numeric" value="0" disabled>
              </div>
            </div>                        
          </div>
      </div>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/persediaan/penyesuaian-barang.js'); ?>"></script>
</body>
</html>