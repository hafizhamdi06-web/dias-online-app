    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">      
        <table id="table" class="table table-sm table-striped table-hover w-100 nowrap">
          ...
          <th class="text-sm">Gudang Asal</th>
          <th class="text-sm">Gudang Tujuan</th>            
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/persediaan/table-mutasi-gudang.js'); ?>"></script>
</body>
</html>