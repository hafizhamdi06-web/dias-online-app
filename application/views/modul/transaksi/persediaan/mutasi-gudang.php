  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <section class="content" style="margin-top:70px">
      <div class="container-fluid pt-4">
          <div class="form-group row my-0">
            <label for="" class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Penerima *</label>
            <div class="col-sm-2">
          ...
          <div class="form-group row my-0">
            <label for="" class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Gudang Tujuan *</label>
            <div class="col-sm-2">
              <select id="gudangtujuan" name="gudangtujuan" class="form-control form-control-sm select2" style="width:100%" data-trigger="manual" data-placement="auto">
              </select>
            </div>
          </div>          
          <div class="form-group row my-0">
            <label for="" class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Pengirim *</label>
            <div class="col-sm-2">
                  <div class="input-group" data-target-input="nearest">
                    <input type="hidden" id="idkontak2" name="idkontak2">                    
                    <input type="text" id="kontak2" name="kontak2" class="form-control form-control-sm" autocomplete="off" data-trigger="manual" data-placement="auto">
                    <div id="carikontak2" class="input-group-append" role="button">
                        <div class="input-group-text"><i class="fa fa-ellipsis-h"></i></div>
                    </div>
                  </div>
            </div>
            <div id="namakontak2" class="col-sm-4 text-sm overflow-hidden text-nowrap pt-1"></div>                        
          </div>                  
          <div class="form-group row my-0">
            <label for="" class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Gudang Asal *</label>
            <div class="col-sm-2">
              <select id="gudangasal" name="gudangasal" class="form-control form-control-sm select2" style="width:100%" data-trigger="manual" data-placement="auto">
              </select>     
            </div>
          </div> 
        </div>
      <div class="container-fluid container-absolute">
          ...
          <div class="row mt-0">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">Tanggal *</label>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">No. Transaksi</label>
          ...
          <div class="row">
            ...
            <div class="col-sm-3 d-none">
                <label class="text-sm px-1 font-weight-normal">No. Permintaan</label>              
                  <div class="input-group" data-target-input="nearest">
                    <input type="hidden" id="idpermintaan" name="idpermintaan">
                    <input type="text" id="nopermintaan" name="nopermintaan" class="form-control form-control-sm" autocomplete="off">
                    <div id="caripermintaan" class="input-group-append" role="button">
                        <div class="input-group-text"><i class="fa fa-ellipsis-h"></i></div>
                    </div>
                  </div>                
            </div>                                                                                                
            <div class="col-sm-3">
                <label class="text-sm px-1 font-weight-normal">No. Ref</label>              
                  <div class="input-group" data-target-input="nearest">
    ...
    <section class="content mt-1">
      <div class="container-fluid">
          <div class="row py-2">
            <label for="" class="col-sm-2 col-form-label text-sm px-4 font-weight-normal">Uraian *</label>
            <div class="col-sm-10">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/persediaan/mutasi-gudang.js'); ?>"></script>
</body>
</html>