  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <section class="content">
      <div id="dLeftFirst" class="container-fluid left">
        <div class="row">
          <label for="" class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Kontak *</label>
          <div class="col-sm-2">
      ...
      <div class="container-fluid left mt-3">
            ...
            <div class="card-body card-outline-tabs-body">
              <div class="tab-content">
                ...
                <div class="table-responsive" tabindex="-1">
                  <table id="tdetil" class="table table-hover table-transaksi table-sm">
                    <thead class="bg-light">
                      <tr>
                        <th class="text-sm text-label text-center border-0" style="width: 300px">COA</th>
                        <th class="text-sm text-label text-center border-0" style="width: 170px">Debit</th>
                        <th class="text-sm text-label text-center border-0" style="width: 170px">Kredit</th>
          ...
          <div class="row">
            ...
            <div class="col-sm-2 py-0">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">Total Debit</label>
                <input id="totaldebet" type="text" class="total form-control form-control-sm numeric border-0" value="0" disabled>
              </div>
            </div>    
            <div class="col-sm-2 py-0">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">Total Kredit</label>
                <input id="totalkredit" type="text" class="total form-control form-control-sm numeric border-0" value="0" disabled>
              </div>
            </div>            
          </div>                
      </div>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/fina/jurnal-umum.js'); ?>"></script>
</body>
</html>