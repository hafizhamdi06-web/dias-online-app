  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <section class="content">
      <div id="dLeftFirst" class="container-fluid left">
        <div class="row">
          <label class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Sudah Terima Dari *</label>
          <div class="col-sm-2">
                <div class="input-group">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/fina/kas-masuk.js'); ?>"></script>
</body>
</html>