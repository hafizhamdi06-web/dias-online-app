  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <section class="content">
      <div id="dLeftFirst" class="container-fluid left">
        ...
        <div class="row">
          <label for="" class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">COA Bank [D] *</label>
          <div class="col-sm-3">
          ...
          <div class="col-sm-1">
            ...
            <input id="uangdebet" type="text" class="form-control form-control-sm total" readonly="" tabindex="-1" value="Rp">
          </div>
          <label class="col-sm-1 col-form-label text-sm px-3 font-weight-normal">Kurs</label>
          <div class="col-sm-1">
            <input id="kursdebet" type="text" class="form-control form-control-sm numeric total" readonly="" tabindex="-1" value="1,00">
          </div>                                    
        </div>                                                                                                         
      </div>
    </section>
                      ...
                      <table id="tdetil" class="table table-hover table-sm table-transaksi">
                        <thead class="bg-light">
                          <tr>
                            ...
                            <th class="text-sm text-label text-center border-0" style="width: 170px">Jumlah [K]</th>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/fina/bank-masuk.js'); ?>"></script>
</body>
</html>