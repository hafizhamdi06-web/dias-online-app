      ...
      <div id="dLeftFirst" class="container-fluid left">
        ...
        <div class="row pt-1">
          ...
          <div class="col-sm-1">
            ...
            <input id="uangkredit" type="text" class="form-control form-control-sm" readonly="" tabindex="-1" value="Rp">
          </div>
          <label class="col-sm-1 col-form-label text-sm px-3 font-weight-normal">Kurs</label>
          <div class="col-sm-1">
            <input id="kurskredit" type="text" class="form-control form-control-sm numeric" readonly="" tabindex="-1" value="1,00">
          </div>                                    
        </div>
        <div class="row pt-0">
          ...
          <div class="card card-primary card-outline card-outline-tabs" style="box-shadow: none">
            ...
            <div class="card-body card-outline-tabs-body">
              <div class="tab-content">
                ...
                <div class="row mt-2 pt-0">
                  ...
                  <button type="button" id="bcarifaktur" class="btn btn-primary btn-step1 text-sm" data-trigger="manual" data-placement="auto">Ambil Data Tagihan</button>                  
                </div>                                 
            ...
            <div class="row px-2">
              ...
              <div class="col-sm-2 py-0">
                <div class="form-group">
                  <label class="text-sm px-1 font-weight-normal">Total Hutang Dibayar</label>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/pembayaran-hutang.js'); ?>"></script>
</body>
</html>