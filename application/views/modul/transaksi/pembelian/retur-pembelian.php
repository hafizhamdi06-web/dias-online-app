<body id="<?= $id; ?>" class="layout-fixed bg-transparent overflow-hidden" data-panel-auto-height-mode="height">
  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <input type="hidden" id="idbkg" name="ididbkg" value="">                                  
    ...
    <section class="content" style="margin-top:70px">
      <div class="container-fluid pt-4">
          ...
          <div class="form-group row my-0" style="height:48px;">
            <label for="" class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Uraian *</label>
            <div class="col-sm-3">
                <textarea id="uraian" name="uraian" class="form-control form-control-sm" autocomplete="off" data-trigger="manual" data-placement="auto" style="height: 3.2em"></textarea>
            </div>            
          </div> 
        </div>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/retur-pembelian.js'); ?>"></script>
</body>
</html>