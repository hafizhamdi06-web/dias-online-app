    ...
    <section class="content" style="margin-top: 70px">
      <div class="container-fluid pt-4">
          <div class="form-group row my-0">
            <label class="col-sm-2 col-form-label text-sm px-3 font-weight-normal">Vendor *</label>
            <div class="col-sm-2">
      ...
      <div class="container-fluid container-absolute">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 d-none">
                <label class="text-sm px-2 font-weight-normal">No. Permintaan</label>              
                  <div class="input-group" data-target-input="nearest">
                    ...
                    <div id="carireferensi" class="input-group-append d-none" role="button">
                        <div class="input-group-text"><i class="fa fa-ellipsis-h"></i></div>
                    </div>
                  </div>                              
            </div>                                    
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">Termin *</label>
                  <select id="termin" name="termin" class="form-control select2 text-sm" style="width:100%">
                  </select>     
              </div>
            </div>                                                                                    
          </div>
    ...
    <section class="content pt-0">
      <div class="container-fluid">
          <div class="row px-0 py-0">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">Sub Total</label>
          ...
          <div class="row px-0 py-0">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">PPN <span id="persen-ppn"><? if($ppnbeli>0) echo '('.$ppnbeli.'%)'; ?></span></label>
            ...
            <div id="col-pph22" class="col-sm-2 d-none">
              <div class="form-group">
                ...
                <label for="chkpph22" class="text-sm px-1 font-weight-normal ml-4">PPH 22 
                  <span id="persen-pph22"><? if($pph22beli>0) echo '('.$pph22beli.'%)'; ?></span>
                </label>                                
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">Total Transaksi</label>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/order-pembelian.js'); ?>"></script>
</body>
</html>