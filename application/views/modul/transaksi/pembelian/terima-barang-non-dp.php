    ...
    <section class="content" style="margin-top: 70px">
      <div class="container-fluid pt-4">
          ...
          <div class="form-group row my-0">
            ...
            <div class="col-sm-3">
              <textarea id="alamat" name="alamat" class="form-control form-control-sm"  autocomplete="off" style="height:4em;resize: none;"></textarea>
            </div>
          </div> 
      </div>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/terima-barang-non-dp.js'); ?>"></script>
</body>
</html>