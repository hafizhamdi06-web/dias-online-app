...
<body id="<?= $id; ?>" class="layout-fixed bg-transparent overflow-hidden" data-panel-auto-height-mode="height">
  ...
  <div class="content-wrapper tab-wrap mx-0">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown d-sm-inline-block">
          ...
          <div class="dropdown-menu dropdown-menu-sm dropdown-menu-left"> 
            ...
            <span class="ml-1">Lihat Jurnal Penerimaan Barang</span></a>            
            <a id="bViewJurnalDP" href="#" class="dropdown-item text-sm"><i class="fas fa-search text-gray"></i>
            <span class="ml-1">Lihat Jurnal Uang Muka</span></a>                        
          </div>        
        </li>
      </ul>         
      </div>
    ...
    <section class="content" style="margin-top: 70px">
      ...
      <div class="container-fluid container-absolute" style="margin-right:15px">
          <!-- Isi -->
          <div class="row mt-2">
            <div class="col-sm-4">
            </div>    
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
                <label class="text-sm px-2 font-weight-normal">No. Order</label>              
                  <div class="input-group" data-target-input="nearest">
                    ...
                    <div id="cariorder" class="input-group-append" role="button">
                        <div class="input-group-text"><i class="fa fa-ellipsis-h"></i></div>
                    </div>
                  </div>                
            </div>                                
            <div class="col-sm-3 d-none">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">Termin *</label>
                  <input  type="hidden" id="termin" name="termin">
                  <!--
                  <select id="termin" name="termin" class="form-control form-control-sm select2" style="width:100%">
                  </select>
                  -->     
              </div>
            </div>
                      ...
                      <table id="tdetil" class="table table-hover table-sm table-transaksi">
                        <thead class="bg-light">
                          <tr>
                            ...
                            <th class="text-sm text-label text-center border-0" style="width: 150px">No. Order</th>
          ...
          <div class="row mt-0 px-2">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <input type="hidden" id="tgldp" name="tgldp">
                <input type="hidden" id="nomordp" name="nomordp">
                <input type="hidden" id="uraiandp" name="uraiandp">
                <input type="hidden" id="coadp" name="coadp">
                <input type="hidden" id="coadpname" name="coadpname">                
                <input type="hidden" id="coadpkas" name="coadpkas">
                <input type="hidden" id="coadpkasname" name="coadpkasname">   
                <input type="hidden" id="pajakdp" name="pajakdp">                                             
                <input type="hidden" id="tglpajakdp" name="tglpajakdp">
                <input type="hidden" id="fakturpajakdp" name="fakturpajakdp">
                <input type="hidden" id="tdpjumlah" name="tdpjumlah" value="0">
                <input type="hidden" id="tdppajak" name="tdppajak" value="0">                                                 
                <input type="hidden" id="triggertdp" name="triggertdp" value="0">                                                
                ...
                <div class="input-group" data-target-input="nearest">                
                  ...
                  <div id="bresetdp" class="input-group-append d-none" role="button" title="hapus uang muka">
                      <div class="input-group-text border-0 px-1"><i class="fas fa-times-circle text-red p-0"></i></div>
                  </div>
                  <div id="buangmuka" class="input-group-append" role="button" style="border-left:1px solid #ddd;">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/terima-barang.js'); ?>"></script>
</body>
</html>