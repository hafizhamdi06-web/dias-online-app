    ...
    <section class="content" style="margin-top: 70px">
      ...
      <div class="container-fluid container-absolute">
          ...
          <div class="row mt-2">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">No. Transaksi x</label>
    ...
    <section class="content mt-4">
      <div class="container-fluid">
          ...
          <div class="row px-2">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="text-sm px-2 font-weight-normal">Tgl Faktur Pajak</label>
                  <div class="input-group date">
          ...
          <div class="row px-2">
            ...
            <div id="col-pph22" class="col-sm-2 col-overlap-2 d-none">
              <div class="form-group">
                ...
                <label for="chkpph22" class="text-sm px-1 font-weight-normal ml-4">PPH 22 <span id="persen-pph22"><? if($pph22beli>0) echo '('.$pph22beli.'%)'; ?></span></label>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/faktur-pembelian-dua.js'); ?>"></script>
</body>
</html>