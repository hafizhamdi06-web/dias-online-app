    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        <table id="table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          ...
          <th class="text-sm">Karyawan</th>
          <th class="text-sm">Depo/Farmasi</th>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/transaksi/pembelian/table-permintaan-barang.js'); ?>"></script>
</body>
</html>
