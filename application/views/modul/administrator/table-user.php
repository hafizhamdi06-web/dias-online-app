  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">      
        <table id="user-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>
          <th></th>
          <th class="text-sm">Kode / NIK</th>
          <th class="text-sm">Nama User</th>
          <th class="text-sm">Nama Lengkap</th>          
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/administrator/table-user.js'); ?>"></script>
</body>
</html>