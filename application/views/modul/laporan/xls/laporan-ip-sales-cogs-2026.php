<?php
    ...
    $CI =& get_instance();
	                  ...
	                  AND sutanggal BETWEEN '".tgl_database($date1)."'  AND '".tgl_database($date2)."'   ";   
	                   ...
	                   $query = "SELECT SUNOTRANSAKSI,CTNAMA,CTTIDAKDITARIK,CTTIPEPRODUK,
	                  sum((sdkeluar*(sdharga-sddiskon))-sdbayardp) as subtotal,
	                  sum(
	                  ...
	                  case when sdkeluar*(sdharga-sddiskon)>0 then 
	                                case when CTTIPEPRODUK=1 then  (sdkeluar*(sdharga-sddiskon)*80/100 ) /1.11 else  sdkeluar*icogs end      
	                    else 0 end
	                  ) as nilaiproduk 
	                  ...
	                  AND sutanggal BETWEEN '".tgl_database($date1)."'  AND '".tgl_database($date2)."'   ";   
	                   ...
	                   if($idgudang != ""){
                        ...
                        $query .= " GROUP by 
                    	  CTURUTAN,CTNAMA,CTTIDAKDITARIK,CTTIPEPRODUK,SUNOTRANSAKSI   
	...
	<table class="table">
		<thead>
			<tr class="bg-dark">
				...
				<th class="left px-1">SUNOTRANSAKSI</th>
