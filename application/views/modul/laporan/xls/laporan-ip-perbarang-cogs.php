...
<div class="content-report">
    <table class="table" border="1">
        <tbody>
            <?php
                $curItem = null;
                $iQty = 0; $iSub = 0; $iCogsBeli = 0; $iCogsItem = 0; $iPasien = array();
                $gQty = 0; $gSub = 0; $gCogsBeli = 0; $gCogsItem = 0; $gPasien = array();

                $flushItem = function() use (&$iQty, &$iSub, &$iCogsBeli, &$iCogsItem, &$iPasien) {
                    ...
                    echo "<td class='right px-1'><b>".eFormatNumber($iCogsBeli,2)."</b></td>";
                    echo "<td class='right px-1'><b>".eFormatNumber($iCogsItem,2)."</b></td>";
                    echo "</tr>";
                    echo "<tr><td colspan='9' style='height:10px;border:0;'></td></tr>";
                };
                ...
                foreach ($datareport->data as $row) {
                    if ($curItem !== $row->ikode) {
                        ...
                        echo "<tr><td colspan='9' class='px-1' style='border:0;padding-top:6px;'><b>Kode Barang</b> &nbsp;:&nbsp; ".$row->ikode."</td></tr>";
                        echo "<tr><td colspan='9' class='px-1' style='border:0;'><b>Nama Barang</b> &nbsp;:&nbsp; ".$row->inama."</td></tr>";
                        ...
                        echo "<th class='right px-1'>COGS SDBeli</th>";
                        echo "<th class='right px-1'>COGS ICOGS</th>";
                        echo "</tr>";
                    }
                    ...
                    echo "<td class='right px-1'>".eFormatNumber($row->cogssdbeli,2)."</td>";
                    echo "<td class='right px-1'>".eFormatNumber($row->cogsicogs,2)."</td>";
                    echo "</tr>";

                    $iQty += $row->qty; $iSub += $row->subtotal;
                    $iCogsBeli += $row->cogssdbeli; $iCogsItem += $row->cogsicogs;
                    $gQty += $row->qty; $gSub += $row->subtotal;
                    $gCogsBeli += $row->cogssdbeli; $gCogsItem += $row->cogsicogs;
        ...
        <tfoot>
            <tr style="border-top:2px solid #000;">
                ...
                <td class="right px-1"><b><?= eFormatNumber($gCogsBeli,2); ?></b></td>
                <td class="right px-1"><b><?= eFormatNumber($gCogsItem,2); ?></b></td>
            </tr>
        </tfoot>
    </table>
    <div class="clear">&nbsp;</div>
