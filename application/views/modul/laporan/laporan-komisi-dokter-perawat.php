...
<?
            ...
            left join bgudang on gid=sales.kcabang
...
?>
	...
	<?
	  ...
	  $query2 = " SELECT gkode,gid, sales.knama as namasales, kjnama, sdcatatankoli,sdkedatangan,concat(sdcatatankoli,sdkedatangan) as nopaketkedatangan, sunotransaksi,sutanggal,ikode,coalesce(ikomisi2020,0) as ikelompok2020,ik2kode, npnamaclinic,
	                   ...
	                   if($idpt != ""){
                        ...
                        $query2 .= " order by gkode,gid,sales.knama, kjnama, ik2kode, sutanggal,sunotransaksi,ikode ";
