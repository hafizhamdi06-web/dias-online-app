<?php
    ...
    $CI =& get_instance();  
	                  ...
	                  $query = "SELECT  npnama, gkode,  '-'   as ikode, inama as inama,icogs, SUM(qty) 'qty', sum(cogs) 'cogs' from
                      (
                      select
	                  ...
	                  WHERE sustatus<>9 and  SDCANCEL=0  and istatus=0  and gpt=6
                      ...
                      ";     
	                   ...
	                   if($idgudang != ""){
                        ...
                        $query .= " GROUP by npnama,gkode, ikode,inama, icogs_lama ,IHARGABELITERAKHIR
                        having  IFNULL(SUM(SDMASUK-( IF(SDDARIPAKET<> 0 AND  SDKEDATANGAN  = 0,0,sdkeluar) ) ),0)>0 ) a
                        group by npnama, gkode ,inama,cogs
