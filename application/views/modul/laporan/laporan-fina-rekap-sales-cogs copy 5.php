	     ...
	     $query = " SELECT  
                ...
                FROM (
                    ...
                    SELECT
                        ...
                        case when npid=1 then 0 else 0 end AS pt1,
                ...
                FROM (
                    ...
                    SELECT
                        ...
                        case when susumber = 'PB' then icogs * sdmasuk else 0 end AS pt_ip,
                        0 AS pt_tmb
			...
			<?
				...
				foreach ($datareport->data as $row) { 
					...
					$sales=0;
                        ...
                        $pembelian_igy+=0 ; //$row->pembelian_igy;
	...
	<table class="table">
		...
		<tbody> 
			<? 
                ...
                $nilai_awal_eiaa=$row->nilai_awal_iaa;
	...
	<table class="table">
		...
		<tbody> 
			<? 
                        ...
                        $pembeliancabang=$pembelian_eih+$pembelian_rni+$pembelian_rnj+$pembelian_iak+$pembelian_daps;
