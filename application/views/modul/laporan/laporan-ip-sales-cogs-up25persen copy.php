<?php
    ...
    $CI =& get_instance();
	              ...
	              $query = " SELECT  GURUTAN,GKODE,CTURUTAN,CTNAMA,CTTIDAKDITARIK,CTTIPEPRODUK,
				  sum(subtotal) as subtotal, 
	              sum(alkeshpp) as alkeshpp,
				  sum(sdkeluar*icogs) as nilaiproduk  from (   
	                 
	                  
	                  
	                  
	                   SELECT  GURUTAN,GKODE,CTURUTAN,CTNAMA,CTTIDAKDITARIK,CTTIPEPRODUK,SDKELUAR,
	                  (
	                  ...
	                  AND sutanggal BETWEEN '".tgl_database($date1)."'  AND '".tgl_database($date2)."'   ";   
	                   ...
	                   if($idpt != ""){
                        ...
                        $query .= ") a GROUP by 
                    	  GURUTAN,GKODE,CTURUTAN,CTNAMA,CTTIDAKDITARIK,CTTIPEPRODUK   
