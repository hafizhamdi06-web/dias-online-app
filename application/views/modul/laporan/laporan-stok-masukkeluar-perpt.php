    ...
    $CI =& get_instance(); 
                      ...
                      ";         
	                   ...
	                   if($idgudang != ""){
                        ...
                        $query .= " GROUP by d.npnama, a.susumber , ikode ) a 
						group by npnama,susumber
						"; 
...
<div class="content-report">
	<table class="table">
		<thead>
			<tr class="bg-dark">
				<th class="left px-1" colspan=3>COGS Produk Terjual dan Terpakai Qty Real</th>  
			</tr>
			<tr class="bg-dark">
