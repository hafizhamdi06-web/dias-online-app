				...
				foreach ($datareport->data as $row) {
    			   ...
    			   if ($tanggal !=  $row->sutanggal ) { 
    			       ...
    			       if ($tanggal != '' and $jumlahdata>1 ) {
    					...
    					echo "<td class='right px-1'>".eFormatNumber($tglalkeshpp,2)."</td>"; 
    					echo "<td class='right px-1'>".eFormatNumber($tglppn,2)."</td>"; 
    					echo "<td class='right px-1'>".eFormatNumber($tglpendapatanklinik,2)."</td>"; 
    					echo "<td class='right px-1'>".eFormatNumber($tglpendapatandokter,2)."</td>"; 
    					echo "</tr>";
    					
    					
    					
    					//tampilkan rekap per tanggal nya 
    					
    					  echo "<tr >"; 
    					echo "<td class='px-2' colspan=7>REKAP PENJUALAN</td>";   
    					echo "</tr>";	 
    			       ...
    			       $jumlahdata=0;
    			       $tglnilaiproduk = 0 ; $tglsubtotal = 0 ; $tglnilaialkes = 0 ; $tglppn=0; $tglpendapatanklinik=0; $tglpendapatandokter=0; $tglalkeshpp=0; 
    			        ...
    			        echo "<tr >"; 
    					echo "<td class='px-2' colspan=7>".$row->sutanggal."</td>";   
    					echo "</tr>";	 
