...
$query = " SELECT  npnama, gkode, ctnamalama,ctnamabaru, ikode, inama,sum(qty) qty, sum(cogs) cogs,icogs from (
	SELECT  npnama, gkode, ctnamalama,ctnamabaru, ikode, inama,qty,icogs, qty*icogs 'cogs' from
                      (
                      select
...
$query .= " GROUP by npnama,gkode,coalama.ctnama,coabaru.ctnama, ikode, inama, iid, isatuan, icogs
 ...
 $query .= "  UNION ALL ";
 $query  .=
 	"SELECT  npnama, gkode, ctnamalama,ctnamabaru, ikode, inama,sum(qty) 'qty',icogs, sum(nilaimasuk-nilaikeluar) 'cogs'   from
                       (
                       select
					 ...
					 sutanggal between '2026/01/01' and '" .	tgl_database($date) .	"' ";
                        ...
                        group by npnama, gkode, ctnamalama,ctnamabaru, ikode, inama
