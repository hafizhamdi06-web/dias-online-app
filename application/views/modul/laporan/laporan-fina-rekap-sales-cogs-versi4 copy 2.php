...
$query =
	"SELECT  npnama, gkode, ctnamalama,ctnamabaru, sum(qty) 'qty', sum(qty*icogs) 'cogs' from
                      (
                      select
	...
	<table class="table"  >
		<thead>
			<tr class="bg-dark">
				...
				<th class="left px-1">Nilai Penjualan</th>
			</tr>
		</thead>
		<tbody>
			<?
				...
				foreach ($datareport->data as $row) {
					$sales=0;
    					...
    					echo "<td class='right px-1'>".eFormatNumber($row->qty,0)."</td>";
    					echo "<td class='right px-1'>".eFormatNumber($row->subtotal,0)."</td>";
    					echo "<td class='right px-1'>".eFormatNumber($row->nilaijual,0)."</td>";
    					echo "</tr>";
                        $pembelian_total+=$row->subtotal;
                        $nilaijual_kmb_total+=$row->nilaijual;
				}
			?>
		</tbody>
		<tfoot>
			<?
    					...
    					echo "<td class='right px-1'>".eFormatNumber($pembelian_total,0)."</td>";
    					echo "<td class='right px-1'>".eFormatNumber($nilaijual_kmb_total,0)."</td>";
    					echo "</tr>";
			?>
		</tfoot>
	</table>
