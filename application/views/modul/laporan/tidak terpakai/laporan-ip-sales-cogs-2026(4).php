                        ...
                        */
                        ...
                        $query2 = "";
                         ...
                         sum(
                                    ...
                                    when ikelompok2020 = 9 and  ikode = 'SWAB ANTIGEN' or ikode = 'PCR'  then 0
                                    ...
                                    select ikelompok2020,sdprorecom,susalesmarketing,ikode,
                    	   ...
                    	   $query2 .= " select ikelompok2020,sdprorecom,susalesmarketing,ikode,
...
?>
	...
	<table class="table">
		<thead>
			<tr class="bg-dark">
				<th class="left px-1" colspan="3">Komisi Omset</th>   
			</tr>
			<tr class="bg-dark">
				<th class="left px-1" width="20%">Dokter</th> 
				<th class="right px-1" width="10%">Sub Total</th> 
