    	...
    	<table class="table" style="margin-top: 0px;">
			<tbody>
				<tr>
					...
					<td ><span>IG : nmwskincare www.nmwskincare.co.id WA : <?= $nohp ?></td> 
...
<div class="content-report">
	<table class="table">
		...
		<tbody>
			<?
				$i = 1;
				$qty = 0; $namapaket =''; $namapromo=''; $sumnilaipaket=0; $ke=0; $kodepaket='';
    			          ...
    			          if ($namapaket!='') {
    			            if ($row->kodepaketlengkap <>   $namapaketlengkap  ) { 
                				...
                				<tr> 
    					            ...
    					            <td class="px-1 py-0"><?= $row->ket ?></td>
    					            <td class="px-1 py-0" colspan=4><?= $row->ketpaket ?></td> 
