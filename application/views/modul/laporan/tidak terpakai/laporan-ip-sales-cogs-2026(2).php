...
<?
            ...
            sum( 
                case when sddaripaket = 1 and sdkedatangan = 0 then 0
                when sddaripaket = 1 and sdkedatangan > 0 then coalesce(F_SUBTOTAL_SPA_KE0_IDPAKET(sdcatatankoli,sditem,sukontak,sdsodurutan),0)
...
?>
	...
	<table class="table" width="50%">
		<thead>
			<tr class="bg-dark">
				<th class="left px-1">Dokter</th> 
				<th class="left px-1">Sub Total</th> 
				<th class="left px-1">Komisi 2 %</th> 	 
			</tr>
		</thead>
		<tbody>
			<?	
