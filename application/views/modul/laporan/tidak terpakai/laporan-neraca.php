	...
	<table class="table">
		<thead>
			<tr class="bg-dark">
				...
				<th class="right px-1" width="22%">Saldo</th>
			</tr>
		</thead>
		<tbody>
			<?
				echo "<tr>
							<td colspan='3' class='py-1 px-1'><b>Aktiva</b></td>
					 </tr>";	
				...
				foreach ($grup->data as $row_grup) {
					...
					echo "<tr>
								<td colspan='3' class='py-1 px-2 text-blue'>$row_grup->CGNAMA</td>
						 </tr>";	
					...
					echo "<tr>
								<td colspan='2' class='py-1 px-2 text-blue'>Total $row_grup->CGNAMA</td>
								<td class='right px-1 py-1' style=\"border-top:.5px solid black\">".eFormatNumber($total,2)."</td>
						 </tr>";																			
				}
				echo "<tr>
							<td colspan='2' class='px-1 py-2'><b>Total Aktiva</b></td>
				...
				echo "<tr>
							<td colspan='3' class='py-1 px-1'><b>Pasiva</b></td>
					 </tr>";	
				...
				echo "<tr>
							<td colspan='2' class='px-1 py-2'><b>Total Pasiva</b></td>
							<td class='right px-1 py-2' style=\"border-top:.5px solid black\"><b>".eFormatNumber($grandtotal,2)."</b></td>
					 </tr>";					    				    						
			?>			
		</tbody>
