  ...
  <div class="row mx-2">
    <label for="" class="col-sm-2 col-form-label text-sm text-brown font-weight-normal">Simbol</label>                    
    <div class="col-sm-3">
      <input type="text" class="form-control form-control-sm" placeholder="" id="simbol" name="simbol" autocomplete="off" data-trigger="manual" data-placement="auto">
    </div>
  </div>                                            
  </div>
...
<script src="<? echo app_url('assets/dist/js/modul/master/form-uang.js'); ?>"></script> 