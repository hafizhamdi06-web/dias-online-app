  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">      
        <table id="contact-table" class="table table-sm table-striped table-hover w-100 bg-light nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>            
          <th></th>
          ...
          <th class="text-sm">No Telepon</th>
          </tr>
          </thead>
        </table>
          ...
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                ...
                <div class="input-group" data-target-input="nearest">
                  <select id="kategori" name="kategori" class="form-control form-control-sm select2"></select>
                </div>
              </div>
          </div>
          <div class="row mt-0 mx-1">
              <div class="col-sm-12">
                <label class="label-filter font-weight-normal">Cabang :</label>
                <div class="input-group" data-target-input="nearest">
          ...
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                <div class="icheck-primary d-inline">
                  <input type="checkbox" id="aktifsaja" name="aktifsaja" checked>
                  <label for="aktifsaja" class="font-weight-normal">Aktif saja</label>
                </div>
              </div>
          </div>
          <div class="row mt-0 mx-1">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/master/table-kontak.js'); ?>"></script>
</body>
</html>