  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        <table id="lain-table" class="table table-sm table-striped table-hover w-100 bg-light nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>
          <th></th>
          ...
          <th class="text-sm">Gudang Terkait</th>
          </tr>
          </thead>
        </table>
        <div id="fDataTable" class="fDataTable d-none">
          ...
          <div class="row mt-0 mx-1">
              <div class="col-sm-12">
                <label class="col-form-label text-sm font-weight-normal">Tipe :</label>
                <div class="input-group" data-target-input="nearest">
                  <select id="tipe" name="tipe" class="form-control select2 form-control-sm"></select>
                </div>
              </div>
          </div>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/master/table-lain.js'); ?>"></script>
</body>
</html>
