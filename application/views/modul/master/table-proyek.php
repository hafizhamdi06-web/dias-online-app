  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">      
        <table id="proyek-table" class="table table-sm table-striped table-hover w-100 bg-light nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>            
          <th></th>
          <th class="text-sm">Kode </th>
          <th class="text-sm">Nama Proyek </th>
          </tr>
          </thead>
        </table>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/master/table-proyek.js'); ?>"></script>
</body>
</html>