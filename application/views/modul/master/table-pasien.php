  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        <table id="pasien-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>
          <th></th>
          ...
          <div class="row mt-2 mx-1">
              <div class="col-sm-12">
                ...
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="ftunai" checked>
                  <label class="form-check-label text-sm" for="ftunai">Tunai</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="fmember" checked>
                  <label class="form-check-label text-sm" for="fmember">Member</label>
                </div>
                <div class="form-check">
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/master/table-pasien.js'); ?>"></script>
</body>
</html>
