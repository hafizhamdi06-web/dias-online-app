  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div id="tabel-content" class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        <table id="update-harga-mp-table" class="table table-sm table-striped table-hover w-100 bg-light nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>
          <th></th>
          ...
          <th class="text-sm text-right">Harga Jual 1</th>
          <th class="text-sm text-right">Harga Jual MP</th>
          </tr>
          </thead>
        </table>
...
<!-- JS Custom -->
<script type="module" src="<? echo app_url('assets/dist/js/modul/master/table-update-harga-mp.js'); ?>"></script>
</body>
</html>
