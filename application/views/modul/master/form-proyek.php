...
<div class="row mx-2">
  <label for="" class="col-sm-3 col-form-label text-sm text-brown font-weight-normal">Nama Pelanggan</label>                    
  <div class="col-sm-9">
    <input type="text" class="form-control form-control-sm" placeholder="" id="pelanggan" name="pelanggan" autocomplete="off">
  </div>
</div>
<div class="row mx-2">
  <label for="" class="col-sm-3 col-form-label text-sm text-brown font-weight-normal">Nilai Proyek</label>                    
  <div class="col-sm-4">
    <input type="text" class="form-control form-control-sm numeric" value="0" id="fee" name="fee" value="0" autocomplete="off">
  </div>
</div>                                                                                      
</div>
...
<script src="<? echo app_url('assets/dist/js/modul/master/form-proyek.js'); ?>"></script>