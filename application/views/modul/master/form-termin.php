  ...
  <div class="row mx-2">
    <label for="" class="col-sm-2 col-form-label text-sm text-brown font-weight-normal">Tempo</label>                    
    <div class="col-sm-3">
    <div class="input-group">    
    <input type="text" class="form-control form-control-sm numeric" id="tempo" name="tempo" autocomplete="off" data-trigger="manual" data-placement="auto">
    <div class="input-group-append">
        <div class="input-group-text bg-white border-0">Hari</i></div>
    </div>
    </div>
    </div>
  </div>                                            
...
<script src="<? echo app_url('assets/dist/js/modul/master/form-termin.js'); ?>"></script> 