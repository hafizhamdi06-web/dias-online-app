...
class M_Fina_Bank_Masuk extends CI_Model {
    ...
    function ubahTransaksi(){
        ...
        $data_detil = array(
                ...
                'cdurutan' => $r,
                'cdnocoa' => $_POST['coadb'],
                'cddebit' => $_POST['totalRp'],
                'cddebitv' => $_POST['totalValas'],
                'cdkurs' => $_POST['kursdb'],
        ...
        // USERLOG
        $uactivity = _anomor(element('Fina_Bank_Masuk',NID));
    ...
    function autonumber($tgl){
        $nomor = 0;
        $nomor1 = $this->M_transaksi->prefixtrans(element('Fina_Bank_Masuk',NID));
