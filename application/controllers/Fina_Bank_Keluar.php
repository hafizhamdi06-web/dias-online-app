...
class Fina_Bank_Keluar extends CI_Controller {
   ...
   function __construct() { 
    ...
    $this->load->model('M_Fina_Bank_Keluar');
   }

   function savedata(){
    if($_POST['id']==''){
      echo $this->M_Fina_Bank_Keluar->tambahTransaksi();
    }else{
      echo $this->M_Fina_Bank_Keluar->ubahTransaksi();      
    }
   }

   function deletedata(){
    echo $this->M_Fina_Bank_Keluar->hapusTransaksi();          
   }
