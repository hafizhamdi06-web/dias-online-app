...
class PJ_POS_HP_dev extends CI_Controller {
   ...
   function __construct() { 
      ...
      $this->load->model('M_PJ_POS_HP_dev');
   }

   function savedata(){
      if($_POST['id']==''){
        echo $this->M_PJ_POS_HP_dev->tambahTransaksi();
      }
      elseif($_POST['id']!='' &&  $_POST['appcanceltransaksi']=='1'){
        echo $this->M_PJ_POS_HP_dev->tambahTransaksi();
      }
      else{
        echo $this->M_PJ_POS_HP_dev->ubahTransaksi();      
      }
   }

   function deletedata(){
      echo $this->M_PJ_POS_HP_dev->hapusTransaksi();          
   }   

   function kirimulangpoint(){
      echo $this->M_PJ_POS_HP_dev->kirimulangpoint();          
   }   
