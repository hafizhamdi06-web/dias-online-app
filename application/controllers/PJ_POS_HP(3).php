...
function getnomorip2(){
   ...
   function get_cek_kupon_otc() {
       ...
       $cabang  = @$_SESSION['cabang'] ;
        ...
        $query  = "    select F_SET_JUMLAH_VOUCHER_OTC('".$notransaksi."','".$tanggal."', '".$idkontak."') 'jumlahvoucher'   "; 
   ...
   function get_cek_kupon_tindakan() {
       ...
       $cabang  = @$_SESSION['cabang'] ;
        ...
        $query  = "    select F_SET_JUMLAH_VOUCHER_TINDAKAN('".$notransaksi."','".$tanggal."', '".$idkontak."') 'jumlahvoucher'   "; 
