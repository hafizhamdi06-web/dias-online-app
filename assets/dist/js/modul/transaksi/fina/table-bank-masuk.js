...
$(function() {
	...
	tabel=$('#table').DataTable({
		...
		"dom": '<"top"pi>tr<"clear">',
		"ajax": {
		    "url":base_url+"Datatable_Transaksi_Full/view_bank_masuk",
		    "type":"post",
	        "data": (data) => {
	...
	$("#badd").click(() => {
		...
		location.href=base_url+"page/bbm";      
	});
	...
	$("#bedit").click(() => {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=base_url+"page/bbm/?id="+id;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-bbm/${id}`)
	});	
