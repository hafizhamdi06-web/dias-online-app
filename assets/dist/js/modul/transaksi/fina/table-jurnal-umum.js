/* ========================================================================================== */
/* File Name : table-jurnal-umum.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	tabel=$('#table').DataTable({
		...
		"dom": '<"top"pi>tr<"clear">',
		"ajax": {
		    "url":base_url+"Datatable_Transaksi_Full/view_jurnal_umum",
		    "type":"post",
	        "data": (data) => {
	...
	$("#badd").click(function() {
		...
		location.href=base_url+"page/ju";      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=`${base_url}page/ju/?id=${id}`;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-ju/${id}`)
	});	
	...
	var _deleteData = () => {
		...
		let nomor = $('#table').DataTable().cell($('#table').DataTable().rows({selected:true}),2).data();
