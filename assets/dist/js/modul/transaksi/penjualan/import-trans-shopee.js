...
$(function () {
  ...
  tabel=$('#riwayat-table').DataTable({
    ...
    "ajax": {
        "url":base_url+"Import_Trans_Shopee/view_riwayat",
        "type":"post"
    },
    "deferRender": true,
    "bInfo":true,
    ...
    "columns": [
          ...
          { "data": "total_pembayaran", "className": "text-right" },
          { "data": "diimport_oleh" },
          { "data": "diimport_pada" }
    ],
...
function _importExcel(){
  ...
  $.ajax({
    "url": base_url+"Import_Trans_Shopee/upload",
    "type": "POST",
    "data": formData,
    "processData": false,
    "contentType": false,
    ...
    "success": function(result){
      ...
      if (result.pesan === 'sukses') {
        Swal.fire({
          ...
          text: result.jumlah+' baris transaksi Shopee berhasil diimport ke staging.',
          icon: 'success',
