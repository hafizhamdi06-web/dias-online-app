...
var _formState2 = () => {
  ...
  $('.buttontambahan').removeAttr('data-dismiss').removeAttr('data-toggle').removeAttr('role');  
    ...
    $(this).on("click", "span[name^='detailitem2']", function(){
      
       let _idbaris = $(this).index('.detailitem');  
      
       //alert(_idx);
       $("div[name^='collapsrow']").eq( $(this).index('.detailitem')).collapse('toggle');
       
      //$('.info').eq($('.picture').index(this)).fadeIn(200);  
       
       //$('.collapsrow').eq($('.detailitem').index(this)).collapse('toggle');
      ...
      $(this).on("click", "span[name^='detailitem']", async function(){
      let _idbaris = $(this).index('.detailitem');
...
var _addRow = () => {
  let  
         ...
         newrow  = "<tr><td width=\"90%\"><div class=\"card  card-body\"  >";
        ...
        newrow += "<span class=\"col-1 col-form-label text-sm px-1 font-weight-normal\" id=\"detailitem[]\" name=\"detailitem[]\">Detail</span>";   
        
                              
        newrow += "</div>";  
        newrow += "</div>"; 
        
        newrow += "<div class=\"collapse\" id=\"collapsrow[]\" name=\"collapsrow[]\">"; 
        ...
        newrow += "<div class=\"form-group row my-0\">";
        newrow += "<label class=\"col-3 col-form-label text-sm px-1 font-weight-normal  sm-none\"></label>";
        ...
        newrow += "</div> ";
        newrow += "<label class=\"col-2 col-form-label text-sm px-1 font-weight-normal sm-none\"></label>";
        newrow += "<div class=\"col-4 sm-none\"> ";
        newrow += "</div>   ";
        newrow += "</div>";
...
var _tampilkancollapse = (idx) => { 
    
    $("div[name^='collapsrow']").eq(idx).collapse('toggle');
