...
var _addRow = () => {
  let  
        ...
        newrow += "<span class=\"col-5 col-form-label text-sm px-1 font-weight-normal\" id=\"spannama[]\" name=\"spannama[]\">Keterangan Produk</span>"; 
        ...
        newrow += " </div> ";          
        newrow += "<span class=\"col-2 col-form-label text-sm px-1 font-weight-normal\" id=\"spanqty[]\" name=\"spanqty[]\" type=\"hidden\"  >Qty</span>";  
        newrow += "<div class=\"col-2\">";
        newrow += "<input name=\"spansubtotal\" id=\"spansubtotal[]\" type=\"text\" class=\"total form-control form-control-sm numeric border-0 kuncitext  font-weight-normal\" value=\"0\">";
        newrow += " </div> ";         
        ...
        newrow += "<input name=\"qty[]\" type=\"text\" class=\"total form-control form-control-sm numeric  \" value=\"1\">";
        newrow += "</div>  ";
        ...
        newrow += "<div class=\"col-4\"> <div class=\"input-group\" data-target-input=\"nearest\">";
        newrow += "<input name=\"harga[]\" type=\"text\" class=\"total form-control form-control-sm kuncitext \" value=\"0\">";
        newrow += "<input name=\"bisaeditharga[]\" type=\"hidden\" value=\"0\">";
        newrow += "<div name=\"bcekharga[]\"  id=\"bcekharga[]\" class=\"input-group-append\" role=\"button\" onclick=\"_cekharga($(this));\"  type=\"hidden\"  > ";
