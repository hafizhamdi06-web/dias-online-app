...
var _AmbilDetailPaket= () => {  
  ...
  $("#bprint").click(() => {
      if($('#id').val()=='') return;    
      window.open(`${base_url}Laporan/preview/page-opj/${$("#id").val()}`)    
  });
...
var _addRow = () => {
  let newrow = "<div class=\"card\"><div class=\"card-body\">";  
      ...
      newrow += " <a href=\"javascript:void(0)\" class=\"btn btn-step1 btn-delrow\" onclick=\"_hapusbaris($(this));\" tabindex=\"-1\"><i class=\"fa fa-minus text-primary\"></i></a> ";
                newrow += "</div> ";
                newrow += " </div>" ;  
