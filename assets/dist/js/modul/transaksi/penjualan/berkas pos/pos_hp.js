    ...
    if($(this).attr('role')) {
      $.ajax({ 
        ...
        "success": function(result) {
          ...
          parent.window._pilihkategorikontak('12'); 
          setTimeout(function (){
               parent.window.$('#modal input').focus();
      ...
      if (typeof result.pesan !== 'undefined') {
        ...
        $.each(result.data, function() {
            ...
            _inputFormat();    
             ...
             jenispromo=result.data[rows]['jenispromo']; 
             if (jenispromo=0)
             {
                qty=result.data[rows]['qtydetil'].replace(".", ",");    
             }
             else
             {
                qty=result.data[rows]['qtydetil1'].replace(".", ",");  
             }
          ...
          var _item = $("<option selected='selected'></option>").val(result.data[rows]['iditem']).text(result.data[rows]['namaitem']),
              ...
              _promo = $("<option selected='selected'></option>").val(result.data[rows]['idpromo']).text(result.data[rows]['namapromo']);                       

              $("select[name^='item']").eq(rows).append(_item).trigger('change');       
              $("select[name^='satuan']").eq(rows).append(_satuan).trigger('change');   
             
              harga=result.data[rows]['hargadetil'].replace(".", ",");        
              dis1=result.data[rows]['dis1detil'].replace(".", ",");        
              dis2=result.data[rows]['dis2detil'].replace(".", ",");
              //diskon=result.data[rows]['diskondetil'].replace(".", ",");                       
              //subtotal=result.data[rows]['subtotaldetil'].replace(".", ",");   
             ...
             // $("input[name^='subtotal']").eq(rows).val(subtotal);   
              ...
              pilihan1=result.data[rows]['pilihan1'];   
...
var _AmbilDetailPaket= () => {  
      ...
      if (typeof result.pesan !== 'undefined') {
        ...
        var rows = 0, nopaket='', kedatangan=0, harga=0, dis1=0, dis2=0, diskon=0, subtotal=0, qty=0, pilihan='' , kepilihan=0 ;
        let fltnya='';
        ...
        $.each(result.data, function() {
          ...
          var _item = $("<option selected='selected'></option>").val(result.data[rows]['iditem']).text(result.data[rows]['namaitem']),
              _satuan = $("<option selected='selected'></option>").val(result.data[rows]['idsatuan']).text(result.data[rows]['satuan']),
              _paket = $("<option selected='selected'></option>").val(result.data[rows]['idpaket']).text(result.data[rows]['namapaket']);                       

          $("select[name^='item']").eq(rows).append(_item).trigger('change');       
          $("select[name^='satuan']").eq(rows).append(_satuan).trigger('change');            
          $("input[name^='qty']").eq(rows).val(result.data[rows]['qtydetil'].replace(".", ",")); 
          
          if (result.data[rows]['kedatangan']==99)
          {  
              kedatangan=0; 
              qty=result.data[rows]['qtydetil'].replace(".", ",");   
              harga=result.data[rows]['hargadetil'].replace(".", ",");        
          ...
          {  
              kedatangan++; 
              qty=result.data[rows]['qtydetiltindakan'].replace(".", ","); 
          }
          ...
          //pilihan=result.data[rows]['pilihan'].replace("|", "','");  
          // $('#pilihanpaketnya').val(pilihan);
          pilihan=result.data[rows]['pilihan']; 
...
var _addRow = () => {
  let newrow = "<div class=\"card \"><div class=\"card-body\">";  
        ...
        newrow += "<select name=\"item[]\" class=\"item form-control select2 form-control-sm\"  data-trigger=\"manual\" data-placement=\"auto\"></select>";
        ...
        newrow += "<div class=\"col-3\">";
        newrow += "<input name=\"dis1[]\" type=\"text\" class=\"total form-control form-control-sm \" value=\"0\">";
        newrow += "</div> ";
        newrow += "<label class=\"col-2 col-form-label text-sm px-1 font-weight-normal\">Harga</label>";
        newrow += "<div class=\"col-4\">";
        newrow += "<input name=\"harga[]\" type=\"text\" class=\"total form-control form-control-sm numeric \" value=\"0\">";
        newrow += "</div>   ";
        newrow += "</div>";
        ...
        newrow += "<div class=\"col-3\">";
        newrow += "<input name=\"dis2[]\" type=\"text\" class=\"total form-control form-control-sm \" value=\"0\">";
        newrow += "</div>   ";
        newrow += "<label class=\"col-2 col-form-label text-sm px-1 font-weight-normal\">Disc</label>";
        newrow += "<div class=\"col-4\">";
        newrow += "<input name=\"diskon[]\" type=\"text\" class=\"total form-control form-control-sm numeric \" value=\"0\">";
        newrow += "</div> ";            
        newrow += "</div>"; 
        ...
        newrow += "<input name=\"subtotal[]\" type=\"text\" class=\"total form-control form-control-sm numeric \" value=\"0\">";
        newrow += " </div> ";         
        newrow += "</div>"; 
        
        
    
       newrow += "<div class=\"card card-primary collapsed-card\">";
       newrow += "<div class=\"card-header\" data-card-widget=\"collapse\" role=\"button\">"; 
       newrow += "<div class=\"form-group row my-0\">"; 
       
       newrow += "<h3 class=\"card-title text-sm text-white font-weight-bold\">Detail Produk</h3>"; 
       newrow += "<div class=\"card-tools py-0 my-0\">  "; 
       newrow += " <button type=\"button\" class=\"btn btn-tool\" data-card-widget=\"collapse\"><i class=\"fas fa-angle-down text-md text-white\"></i></button>  "; 
       newrow += "</div>  "; 
       ...
       newrow += "<div class=\"card-body\"> ";  
        ...
        newrow += "</div>"; 
         ...
         newrow += "<div class=\"col-3\">"; 
         newrow += "<input name=\"nopaketdetil[]\" type=\"text\" class=\"form-control form-control-sm\"  autocomplete=\"off\">";  
         newrow += "</div>"; 
         newrow += "<label class=\"col-3 col-form-label text-sm px-1 font-weight-normal\">Ke-</label>"; 
         newrow += "<div class=\"col-3\">"; 
         newrow += "<input name=\"kedatanganke[]\" type=\"text\" class=\"form-control form-control-sm\"  autocomplete=\"off\">"; 
         newrow += "</div> "; 
         newrow += "</div>"; 
        ...
        newrow += "<div class=\"col-9\">";
        newrow += "<select name=\"paket[]\" class=\"paket form-control select2 form-control-sm\"  data-trigger=\"manual\" data-placement=\"auto\"></select>";
        ...
        newrow += "<div class=\"col-9\">";
        newrow += "<select name=\"promo[]\" class=\"promo form-control select2 form-control-sm\"  data-trigger=\"manual\" data-placement=\"auto\"></select>"; 
        newrow += "</div></div>"; 
        ...
        newrow += "</div> ";
       newrow += " <a href=\"javascript:void(0)\" class=\"btn btn-step1 btn-delrow\" onclick=\"_hapusbaris($(this));\" tabindex=\"-1\">Hapus Item</a> ";
               newrow += " </div>" ;  
  ...
  $.ajax({ 
    ...
    "success": function(result) {
      ...
      if(result.pesan=='sukses'){ 
           if(result.statusemail=='0') parent.window.toastr.error("Gagal Email Karena "+result.eroremail);  
           if(result.statusemail=='1') parent.window.toastr.success("Email sukses dikirim");  
          ...
          parent.window.Swal.fire({
              ...
              if (printing.isConfirmed) {
                window.open(`${base_url}Laporan/preview/page-opj/${result.nomor}`)
              }
