...
var _AmbilDetailPasien = () => { 
      ...
      $.ajax({ 
        ...
        { 
           ...
           {
            $('#divtglexpiredmember').append("<button type=\"button\" class=\"btn btn-danger btn-step1 text-sm btn-sm  bexpiredmember\" role=\"button\"  > Member Sudah Expired Tanggal <span class=\"badge badge-light\" >"+result.data[0]['tglexpired']+"</span></button>");
            $('#statusmember').val(0);  
           }
           else 
           { 
