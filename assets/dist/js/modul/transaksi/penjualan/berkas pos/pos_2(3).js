...
$("#bweb").click(function() {  
    ...
    $.ajax({ 
      ...
      "beforeSend": function(){
        parent.window.$(".loader-wrap").removeClass("d-none");        
        parent.window.$(".modal").modal("show");                  
        parent.window.$(".modal-title").html("Cari Transaksi WEB");
        parent.window.$("#modaltrigger").val("iframe-page-pos_2");   
  ...
  $("#bpro").click(function() { 
   ...
   var _AmbilDetailPRO = () => {   
    ...
    //const cek1 = await $('#modaloperator').modal('show'); 
  ...
  $("#bsave").click(function() { 
    ...
    //_saveData(); 
    // save dipindah ke button pilih DKK
    if (_IsValid()!==0)
    {
     $('#modalDKK').modal('show');  
    }
  ...
  $("#btambahitem").click(function() {   
    ...
    if($('#idkontak').val()==''){
      ...
      return 0;
            ...
            $('#modaltambahitem').on('shown.bs.modal', function(){  
                           $('#pilihanitem').focus();   
                        }); 
  ...
  $("#bokpilihitem").click(function() {   
    ...
    if($('#pilihanitem').val()=='' || $('#pilihanitem').val()==null ){
...
//newrow += "<span class=\"col-2 col-form-label text-sm px-1 font-weight-normal numeric\" id=\"spanhargabersih[]\" name=\"spanhargabersih[]\">Harga Nett</span>";  
var _addRow = () => {
  let  
        
         newrow  = "<tr><td width=\"90%\"><div class=\"card  collapsed-card\"  >";
        newrow += "<div class=\"card-header\" data-card-widget=\"collapse\">";  
        newrow += "<div class=\"form-group row my-0\">";  
        newrow += "<span class=\"col-1 col-form-label text-sm px-1 font-weight-normal\" id=\"spanurutan[]\" name=\"spanurutan[]\">1</span> "; 
        newrow += "<span class=\"col-4 col-form-label text-sm px-1 font-weight-normal\" id=\"spannama[]\" name=\"spannama[]\">Keterangan Produk</span>";
        
      
        newrow += "<div class=\"col-2 col-sm-2 col-lg-1\">";
        newrow += "<input name=\"qty[]\" type=\"text\" class=\"total form-control form-control-sm numeric  \" value=\"0\">";
        newrow += "</div>";
        
        newrow += "<div class=\"col-2\">";
        ...
        newrow += "<div class=\"col-2\">";
        newrow += "<input name=\"spansubtotal\" id=\"spansubtotal[]\" type=\"text\" class=\"total form-control form-control-sm numeric border-0 kuncitext  font-weight-normal\" value=\"0\">";
        newrow += " </div> ";         
        
        newrow += "<div class=\"col-1\">";
        newrow += "<div class=\"card-tools py-0 my-0\"><button type=\"button\" class=\"btn btn-tool\" data-card-widget=\"collapse\"><label class=\"col-form-label text-sm px-1 font-weight-normal\">Detail</label><i class=\"fas fa-angle-down text-md\"></i></button></div>";  
        newrow += " </div> ";   
        ...
        newrow += "<div class=\"form-group row my-0\">";
        newrow += "<label class=\"col-3 col-form-label text-sm px-1 font-weight-normal  sm-none\">Qy</label>";
        newrow += "<div class=\"col-3 sm-none\">";
        newrow += "<input name=\"qty2[]\" type=\"text\" class=\"total form-control form-control-sm numeric  \" value=\"1\">";
        newrow += "</div>  ";
        ...
        newrow += "</div> ";
        newrow += "<label class=\"col-2 col-form-label text-sm px-1 font-weight-normal sm-none\">Harga</label>";
        newrow += "<div class=\"col-4 sm-none\"> <div class=\"input-group  sm-none\" data-target-input=\"nearest\">";
        newrow += "<input name=\"hargax[]\" type=\"text\" class=\"total form-control form-control-sm kuncitext \" value=\"0\">";
        newrow += "<input name=\"bisaedithargax[]\" type=\"hidden\" value=\"0\">";
        newrow += "<div name=\"bcekhargax[]\"  id=\"bcekharga[]\" class=\"input-group-append\" role=\"button\" onclick=\"_cekharga($(this));\"  type=\"hidden\"  > ";
        newrow += "<div class=\"input-group-text\"><i class=\"fa fa-ellipsis-h\"></i></div></div>   "; 
        newrow += "</div></div>   ";
        newrow += "</div>";
        ...
        newrow += "<input name=\"subtotal[]\" type=\"text\" class=\"total form-control form-control-sm kuncitext\" value=\"0\">";
        newrow += " </div> ";         
        newrow += "</div>";  
...
var _saveData = () => {
  ...
  const id = $("#id").val(),
        ...
        medid= $("#medid").val(),idmedlib=$("#idmedlib").val() 
...
var _hitungJumlahDetil = (idx) => { 
 ...
 vharganet1=vharga;
  ...
  var _TampilkanNamaItem = (xBaris) => {   
    ...
    xspanqty= $("input[name^='qty']").eq(xBaris).val();
    xspanhargabersih= $("input[name^='subtotal']").eq(xBaris).val() ; 
   
    
    
   $("span[name^='spannama']").eq(xBaris).html(xspannama);
   $("span[name^='spanqty']").eq(xBaris).html(xspanqty); 
   $("input[name^='spansubtotal']").eq(xBaris).val(xspanhargabersih);
