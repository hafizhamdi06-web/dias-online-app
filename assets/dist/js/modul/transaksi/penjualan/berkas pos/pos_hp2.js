...
var _AmbilDetailPasien = () => { 
      ...
      $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/get_detail_pasien", 
        "type"   : "POST", 
    ...
    window.catatanplanning = function() {  
     ...
     window.medlibbeluminvoice = function() { 
      ...
      var _AmbilDetailWEB_blmiv = () => {   
          ...
          $.ajax({ 
            "url"    : base_url+"PJ_POS_HP_dev/get_detail_web_blmiv", 
            "type"   : "POST",  
...
$("#bweb").click(function() {  
  ...
  var _AmbilDetailWEB = () => {   
      ...
      $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/get_detail_web", 
        "type"   : "POST",  
 ...
 $("#bpasien").click(function() { 
  ...
  $("#bpro").click(function() { 
   ...
   var _AmbilDetailPRO = () => {   
      ...
      $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/get_detail_pro", 
        "type"   : "POST",  
  ...
  var _AmbilDetailPromo = () => {  
      ...
      $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/get_detail_promo", 
        "type"   : "POST",  
...
var _hitunghari = (_Tgl1, _Tgl2) => {  
  ...
  var _AmbilDetailPaket= () => { 
    ...
    if($('#idkontak').val()==''){
      ...
      $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/get_detail_paket", 
        "type"   : "POST",  
  ...
  $("#bokpilihanpaket").click(function() { 
     ...
     let _kode = '', _urutan=0;
       ...
       $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/get_item", 
        "type"   : "POST", 
   ...
   $("#carivoucher").click(function() {   
    ...
    if($('#idkontak').val()==''){
      ...
      return 0;
       ...
       $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/getdata_voucher",      
    "type"   : "POST", 
    "dataType" : "json",  
   ...
   $("#caridp").click(function() {   
    ...
    if($('#idkontak').val()==''){
      ...
      return 0;
       ...
       $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/getdata_dp",      
    "type"   : "POST", 
    "dataType" : "json",  
    "data" : {xid: $("#idkontak").val()},
    "cache"  : false,
   ...
   $("#carisurgerydp").click(function() {   
    ...
    if($('#idkontak').val()==''){
      ...
      return 0;
       ...
       $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/getdata_surgerydp",      
    "type"   : "POST", 
    "dataType" : "json",  
    "data" : {xid: $("#idkontak").val()},
    "cache"  : false,
    ...
    if($('#txtidbarang').val()=='' || $('#txtidbarang').val()==null ){
     ...
     let _iditem = $('#txtidbarang').val();  
       ...
       $.ajax({ 
        ...
        _addRow(); 
        _inputFormat(); 
        var _idx = $("select[name^='item']").length , wajibdokter=0; 
        _idx=_idx-1; 
           ...
           alert('Pastikan jumlah produk sudah diinput sesuai jenisnya.')
                    ...
                    $.ajax({ 
                      ...
                      "success": function(result) {
                        ...
                        parent.window._transaksidatatable('view_diskonvocer');   
                          setTimeout(function (){
                               parent.window.$('#modal input').focus();
                          }, 500);
                        return;
 ...
 $("#bokmodalvoucherweb").click(function() { 
    ...
    let _idx = $('#keberapa').val(); 
     ...
     let _kode = '', _urutan=0, _kontak='';
       ...
       $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/getdata_voucherweb", 
        "type"   : "POST", 
 ...
 $("#bokmodalpassword").click(function() {  
    ...
    let _idx = $('#keberapa').val(); 
     ...
     let _kode = '', _urutan=0, _kontak='';
       ...
       $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/getdata_bukapassword", 
        "type"   : "POST",  
              ...
              }  else  
              {
                  //_kontak = result.data[0]['kontak'] ; 
                        ...
                        if ( _jenis=='editharga')
                        {
                           ...
                           $('#modalpassword').modal('hide'); 
                           parent.window.toastr.success("Sukses membuka Kunci harga " + $("span[name^='spannama']").eq(_idx).html() );   
...
var _addRow = () => {
  let  
        ...
        newrow += "<span class=\"spannama col-4 col-form-label text-sm px-3 font-weight-normal\" id=\"spannama[]\" name=\"spannama[]\">Keterangan Produk</span>"; 
        newrow += "<input name=\"qty[]\" type=\"tel\" class=\"qty col-1 form-control form-control-sm\"  autocomplete=\"off\"  value=\"0\">"; 
        newrow += "<input name=\"harga[]\" type=\"tel\" class=\"harga col-1 form-control form-control-sm numeric kuncitext \" autocomplete=\"off\"  value=\"0\">";
        ...
        newrow += "<input name=\"subtotal[]\" type=\"text\" class=\"subtotal col-1 form-control form-control-sm numeric kuncitext\" autocomplete=\"off\" tabindex=\"-1\" value=\"0\">"; 
        ...
        newrow += "<input name=\"cetak[]\" type=\"hidden\" class=\"form-control form-control-sm\">";
        newrow += "</div></div></div>";  
        ...
        newrow += "<div class=\"col-3\">";
        newrow += "";
        newrow += "<input name=\"diskon2[]\" type=\"hidden\" class=\"total form-control form-control-sm kuncitext\" value=\"0\">";
        newrow += "</div>   ";
        newrow += "<label class=\"col-2 col-form-label text-sm px-1 font-weight-normal\">Disc</label>";
        newrow += "<div class=\"col-4\">";
        newrow += "<input name=\"diskon[]\" type=\"text\" class=\"total form-control form-control-sm kuncitext\" value=\"0\">";
        newrow += "</div> ";            
        newrow += "</div>"; 
        ...
        newrow += "</div>"; 
         ...
         newrow += "<div class=\"col-3\">"; 
         newrow += "<input name=\"nopaketdetil[]\" type=\"text\" class=\"nopaketdetil form-control form-control-sm kuncitext\"  autocomplete=\"off\">";  
         newrow += "</div>"; 
        ...
        newrow += "</div></div>";
         ...
         newrow += "<input name=\"idvoucherwebdetil[]\" type=\"text\" class=\"idvoucherwebdetil form-control form-control-sm kuncitext\"  autocomplete=\"off\">";  
         newrow += "</div>";  
...
var _addRow2 = () => {
  let  
         ...
         newrow  = "<tr><td width=\"98%\" ><div class=\"card  card-body \"  >";
        newrow += "<div class=\"form-group row my-0\">";  
        newrow += "<span class=\"spannama col-5 col-form-label text-sm px-0 font-weight-normal\" id=\"spannama[]\" name=\"spannama[]\">Keterangan Produk</span>"; 
        newrow += "<input name=\"qty[]\" type=\"tel\" class=\"qty col-2 form-control form-control-sm\"  autocomplete=\"off\"  value=\"0\">"; 
       ...
       newrow += "<div class=\"dropdown col-1\">";  
       newrow += "<button class=\"btn btn-warning text-sm btn-sm dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\" aria-expanded=\"false\">";  
       newrow += "<i class=\"fa fa-ellipsis-h\"></i></button>";  
       newrow += "<div class=\"dropdown-menu\">";   
       newrow += "<button class=\"bvoucherweb dropdown-item\" type=\"button\" id=\"bvoucherweb\" name=\"bvoucherweb\" >Voucher Web</button>";  
       newrow += "<button class=\"beditharga dropdown-item\" type=\"button\" id=\"beditharga\" name=\"beditharga\" >Edit Harga</button>";   
        ...
        newrow += "<label class=\"col-3 col-form-label text-sm px-1 font-weight-normal\">Disc 2</label>";
        newrow += "<div class=\"col-3\">";
        newrow += "<input name=\"dis2[]\" type=\"text\" class=\"dis2 form-control form-control-sm kuncitext\" value=\"0\">";
        newrow += "<input name=\"diskon2[]\" type=\"hidden\" class=\"total form-control form-control-sm kuncitext\" value=\"0\">";
        newrow += "</div>   ";
        newrow += "<label class=\"col-2 col-form-label text-sm px-1 font-weight-normal\">Disc</label>";
        newrow += "<div class=\"col-4\">";
        ...
        newrow += "</td><td vertical-align: top>" ; 
...
var _kirimulangpointteman = () => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/kirimulangpoint", 
    "type"   : "POST", 
...
var _deleteData = () => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/deletedata", 
    "type"   : "POST", 
...
var _saveData = () => {
  ...
  $("select[name^='item']").each(function(index,element){  
      detil.push({
               ...
               diskon2:Number($("input[name^='diskon2']").eq(index).val().split('.').join('').toString().replace(',','.')),
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/savedata", 
    "type"   : "POST", 
    "data"   : rey,
    "processData": false,
    "contentType": false,
...
var _getDataTransaksi = (id) => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_POS_HP_dev/getdata",       
    "type"   : "POST", 
    "dataType" : "json", 
    "data" : "id="+id,
    "cache"  : false,
    ...
    "success" : function(result) {
      ...
      if (typeof result.pesan !== 'undefined') {
        ...
        $.each(result.data, function() {
          ...
          $("input[name^='dis2']").eq(rows).val(result.data[rows]['dis2detil'].replace(".", ","));  
          $("input[name^='diskon']").eq(rows).val(result.data[rows]['diskondetil'].replace(".", ",")); 
          $("input[name^='diskon2']").eq(rows).val(result.data[rows]['diskondetil2'].replace(".", ","));                       
          $("input[name^='subtotal']").eq(rows).val(result.data[rows]['subtotaldetil'].replace(".", ","));   
...
var _hitungJumlahDetil = (idx) => {   
 ...
 vharganet1=vharga;
  ...
  $("input[name^='diskon2']").eq(idx).val(vdiskon2);
 
  $("input[name^='spansubtotal']").eq(idx).val(vsubtotal).attr('placeholder',vsubtotal);
  ...
  var _TampilkanNamaItem = (xBaris) => {   
   ...
   $("span[name^='spannama']").eq(xBaris).html(xspannama);
                        ...
                        if ($("input[name^='bisaeditharga']").eq(i).val()=='1')
                          { 
                             ...
                             // alert('bisa edit harga' + $("select[name^='item']").eq(i).text());  
                              ...
                              $("input[name^='harga']").eq(i).addClass('total form-control form-control-sm numeric'); 
                              //let tharga = 0 ;
...
var _hitungsubtotal = () => {
 ...
 // $('#totaltanpadp').val(vtotaltanpadp).attr('placeholder',vtotaltanpadp);    
  $('#ptotaltransaksi').html(tsubtotal).attr('placeholder',tsubtotal);   
...
var _set_nomor_ip = (xtgl) => { 
    $.ajax({ 
        "url"    : base_url+"PJ_POS_HP_dev/getnomorip",       
        "type"   : "POST", 
        "dataType" : "json", 
        "data" : "tgl="+xtgl,
        "cache"  : false,
