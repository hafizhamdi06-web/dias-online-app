/* ========================================================================================== */
/* File Name : table-surat-jalan.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	tabel=$('#table').DataTable({
		...
		"dom": '<"top"pi>tr<"clear">',
		"ajax": {
		    "url":base_url+"Datatable_Transaksi_Full/view_surat_jalan",
		    "type":"post",
	        "data": function(data){
	...
	$("#badd").click(function() {
		...
		location.href=`${base_url}page/sj`;      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=`${base_url}page/sj/?id=${id}`;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-sj/${id}`)
	});			
