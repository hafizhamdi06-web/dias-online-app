...
$(function () {
  ...
  tabel=$('#riwayat-table').DataTable({
    ...
    "ajax": {
        "url":base_url+"Import_Trans_Tokped/view_riwayat",
        "type":"post"
    },
    "deferRender": true,
    "bInfo":true,
...
function _importExcel(){
  ...
  $.ajax({
    "url": base_url+"Import_Trans_Tokped/upload",
    "type": "POST",
    "data": formData,
    "processData": false,
    "contentType": false,
    ...
    "success": function(result){
      ...
      if (result.pesan === 'sukses') {
        Swal.fire({
          ...
          text: result.jumlah+' baris transaksi Tokopedia berhasil diimport ke staging.',
          icon: 'success',
