/* ========================================================================================== */
/* File Name : table-pembayaran-piutang.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	"dom": '<"top"pi>tr<"clear">',
	"ajax": {
	    "url":base_url+"Datatable_Transaksi_Full/view_pembayaran_piutang",
	    "type":"post",
        "data": function(data){
	...
	$("#badd").click(function() {
		...
		location.href=base_url+"page/ppj";      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=base_url+"page/ppj/?id="+id;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-ppj/${id}`)
	});	
