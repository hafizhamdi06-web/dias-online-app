/* ========================================================================================== */
/* File Name : faktur-penjualan-dua.js
/* Info Lain : 
/* ========================================================================================== */
...
/* ========================================================================================== */
  ...
  $("#bTable").click(function() {
    ...
    location.href=base_url+"page/fpjnData";      
  });
  ...
  $("#bViewJurnal").click(function() {
      ...
      $.ajax({ 
        ...
        "beforeSend": function(){
          ...
          parent.window.$("#modaltrigger").val("iframe-page-fpjn");
    ...
    if($(this).attr('role')) {
      $.ajax({ 
        ...
        "beforeSend": function(){
          ...
          parent.window.$("#modaltrigger").val("iframe-page-fpjn");
          parent.window.$('#coltrigger').val('person');                
        },         
        "error": function(){
          parent.window.$('.loader-wrap').addClass('d-none');
...
var _deleteData = () => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_Faktur_Penjualan/deletedatadua", 
    "type"   : "POST", 
...
var _saveData = () => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_Faktur_Penjualan/savedatadua", 
    "type"   : "POST", 
    "data"   : rey,
    "processData": false,
    "contentType": false,
...
var _getDataTransaksi = (id) => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_Faktur_Penjualan/getdatadua",       
    "type"   : "POST", 
    "dataType" : "json", 
    "data" : "id="+id,
    "cache"  : false,
...
var _getDataOrder = (id) => {
  ...
  $.ajax({ 
    "url"    : base_url+"PJ_Faktur_Penjualan/getdataorder",       
    "type"   : "POST", 
    "dataType" : "json", 
    "data" : "id="+id.toString(),
    "cache"  : false,
    ...
    "error"  : function(xhr){
      console.log(xhr.responseText);
      parent.window.toastr.error('Error : Gagal mengambil data order penjualan !');
      parent.window.$('.loader-wrap').addClass('d-none');                  
      return;
    },
    "success" : async function(result){
      if (typeof result.pesan !== 'undefined') { 
        ...
        $("#termin").append(_termin).trigger('change');   
