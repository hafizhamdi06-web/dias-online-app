...
(function (global, factory) {
  ...
  var Default$7 = {
    ...
    onTabCreated: function onTabCreated(item) {
      /* Modif by Reldi */
      $__default['default']('.loader-wrap').removeClass('d-none');
      /**/
      return item;
    },
    autoIframeMode: true,
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen, tabtitle) {
      var _this = this;
      var tabId = "panel-" + uniqueName;
      var navId = "tab-" + uniqueName;
      var frameId = "iframe-" + uniqueName;
      ...
      var newNavItem = "<li class=\"nav-item\" role=\"presentation\"><i class=\"fas fa-globe nav-link-icon\" aria-selected=\"true\"></i><a href=\"#\" class=\"btn-iframe-close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link pl-4\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + tabtitle + "</a></li>";
      $__default['default'](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
      var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe id=\""+ frameId +"\" src=\"" + link + "\"></iframe></div>";
      ...
      if (autoOpen) {
        if (this._config.loadingScreen) {
          ...
          $__default['default'](tabId + " iframe").ready(function () {
            setTimeout(function(){
              const lAuthor = $('meta[name=author]').attr('content').length+3;
              const lTitle = $("#"+frameId).contents().find('title').text().length - lAuthor;                           
              const authorcontent = $("#"+frameId).contents().find('title').text().substr(0,lTitle);           

              if(authorcontent===title){
              }else {
                $__default['default']('.loader-wrap').addClass('d-none');                
              }
            },2000);
          });
          //end                    
...
//      $__default['default']('.loader-wrap').addClass('d-none');
    ...
    _proto.openTabSidebar = function openTabSidebar(item, autoOpen) {
      ...
      if (!this._config.allowDuplicates && $__default['default']("#" + navId).length === 0 || this._config.allowDuplicates) {
        this.createTab(title, link, uniqueName, autoOpen, tabtitle);
      }
    };
    ...
    _proto.removeActiveTab = function removeActiveTab(type, element) {
      if (type == 'all') {
        $__default['default'](SELECTOR_TAB_NAVBAR_NAV_ITEM + ":not(.tab-index)").remove();
        $__default['default'](SELECTOR_TAB_PANE + ":not(.panel-index)").remove();
        this.switchTab("#tab-index");
//        $__default['default'](SELECTOR_TAB_NAVBAR_NAV_ITEM).remove();
//        $__default['default'](SELECTOR_TAB_PANE).remove();
//        $__default['default'](SELECTOR_TAB_EMPTY).show();
      } else if (type == 'all-other') {
        $__default['default'](SELECTOR_TAB_NAVBAR_NAV_ITEM + ":not(.active,.tab-index)").remove();
        $__default['default'](SELECTOR_TAB_PANE + ":not(.active,.panel-index)").remove();
    ...
    _proto.remember = function remember() {
      ...
      if (toggleState === CLASS_NAME_COLLAPSED) {
        if (this._options.noTransitionAfterReload) {
          $body.addClass('hold-transition').addClass(CLASS_NAME_COLLAPSED).delay(0).queue(function () {
        ...
        $body.addClass('hold-transition').removeClass(CLASS_NAME_COLLAPSED).delay(0).queue(function () {
          $__default['default'](this).removeClass('hold-transition');
          $__default['default'](this).dequeue();
        });
      } else {
